! function(r) {
	...
	function n(r, t, e) {
		...
		1 === n || 2 === n ? function(r, t, e) {
			...
			var a = i.measureText(e.label).width,
				...
				g = l + u,
				d = .01;
			1 === e.mode ? r.addBlank(0, l - d, n, g + d) : r.addBlank(c - d, l - d, h + d, g + d), t.fillStyle = e.fontcolor,
				t.font = o, t.fillText(e.label, c * n, l * n + .75 * e.mSize * n)
			...
			var n = e.size,
				...
				l = c + a,
				h = .01;
			3 === e.mode ? r.addBlank(0, c - h, n, l + h) : r.addBlank(f - h, c - h, s + h, l + h), t.drawImage(e.image, f * n,
				c * n, u * n, a * n)
		}(r, t, e)
	}
	...
	function i(r, t, e, n, o, i, a, u) {
		...
		p ? function(r, t, e, n, o, i, a, u, f, c) {
			a ? r.moveTo(t + i, e) : r.moveTo(t, e), u ? (r.lineTo(n - i, e), r.arcTo(n, e, n, o, i)) : r.lineTo(n, e), f ? (r.lineTo(
				n, o - i), r.arcTo(n, o, t, o, i)) : r.lineTo(n, o), c ? (r.lineTo(t + i, o), r.arcTo(t, o, t, e, i)) : r.lineTo(
				t, o), a ? (r.lineTo(t, e + i), r.arcTo(t, e, n, e, i)) : r.lineTo(t, e)
			...
			a && (r.moveTo(t + i, e), r.lineTo(t, e), r.lineTo(t, e + i), r.arcTo(t, e, t + i, e, i)), u && (r.moveTo(n - i, e),
				...
				n, o - i), r.arcTo(n, o, n - i, o, i)), c && (r.moveTo(t + i, o), r.lineTo(t, o), r.lineTo(t, o - i), r.arcTo(t,
				o, t + i, o, i))
	...
	function a(r, t, e) {
		...
		if (s(e.fill).is("img")) {
			...
			t.globalCompositeOperation = "destination-out", t.fill(), t.globalCompositeOperation = l, t.clip(), t.drawImage(e.fill,
			...
			var o = t,
				...
				p = function(r, t) {
					s = function(r) {
						...
						return t
					}(l = 4 * o + 17), w(0, 0), w(l - 7, 0), w(0, l - 7), T(), m(), E(r, t), o >= 7 && y(r), null == g && (g = k(o,
						a, d)), A(g, t)
				},
				w = function(r, t) {
					for (var e = -1; 7 >= e; e += 1)
						if (!(-1 >= r + e || r + e >= l))
							for (var n = -1; 7 >= n; n += 1) - 1 >= t + n || t + n >= l || (s[r + e][t + n] = e >= 0 && 6 >= e && (0 == n ||
								6 == n) || n >= 0 && 6 >= n && (0 == e || 6 == e) || e >= 2 && 4 >= e && n >= 2 && 4 >= n)
				},
				m = function() {
				...
				T = function() {
					for (var r = i.getPatternPosition(o), t = 0; t < r.length; t += 1)
						for (var e = 0; e < r.length; e += 1) {
							...
							if (null == s[n][a])
								for (var u = -2; 2 >= u; u += 1)
									for (var f = -2; 2 >= f; f += 1) s[n + u][a + f] = -2 == u || 2 == u || -2 == f || 2 == f || 0 == u && 0 ==
										f
						}
				},
				y = function(r) {
					...
					for (var t = r.getModuleCount(), e = 0, n = 0; t > n; n += 1)
						for (s = 0; t > s; s += 1) {
							for (var o = 0, i = r.isDark(n, s), a = -1; 1 >= a; a += 1)
								if (!(0 > n + a || n + a >= t))
									for (var u = -1; 1 >= u; u += 1) 0 > s + u || s + u >= t || (0 != a || 0 != u) && i == r.isDark(n + a, s +
										u) && (o += 1);
							o > 5 && (e += 3 + o - 5)
						}
					for (n = 0; t - 1 > n; n += 1)
						for (s = 0; t - 1 > s; s += 1) {
							var f = 0;
							r.isDark(n, s) && (f += 1), r.isDark(n + 1, s) && (f += 1), r.isDark(n, s + 1) && (f += 1), r.isDark(n + 1, s +
								1) && (f += 1), (0 == f || 4 == f) && (e += 3)
						}
					for (n = 0; t > n; n += 1)
						for (s = 0; t - 6 > s; s += 1) r.isDark(n, s) && !r.isDark(n, s + 1) && r.isDark(n, s + 2) && r.isDark(n, s +
							3) && r.isDark(n, s + 4) && !r.isDark(n, s + 5) && r.isDark(n, s + 6) && (e += 40);
					for (s = 0; t > s; s += 1)
						for (n = 0; t - 6 > n; n += 1) r.isDark(n, s) && !r.isDark(n + 1, s) && r.isDark(n + 2, s) && r.isDark(n + 3,
							s) && r.isDark(n + 4, s) && !r.isDark(n + 5, s) && r.isDark(n + 6, s) && (e += 40);
			...
			h = function(r, t, e, n) {
				for (var o = function(r, t) {
						...
						i.setPixel = function(r, t, n) {
							...
							r.writeString("GIF87a"), r.writeShort(e), r.writeShort(n), r.writeByte(128), r.writeByte(0), r.writeByte(0),
								r.writeByte(0), r.writeByte(0), r.writeByte(0), r.writeByte(255), r.writeByte(255), r.writeByte(255), r.writeString(
						...
						var a = function(r) {
								...
								for (l += 1; l < o.length;) {
									...
									l += 1, i.contains(h + g) ? h += g : (c.write(i.indexOf(h), n), i.size() < 4095 && (i.size() == 1 << n && (
										n += 1), i.add(h + g)), h = g)
								}
				...
				f.flush();
				var h = "";
				return h += "<img", h += ' src="', h += "data:image/gif;base64,", h += f, h += '"', h += ' width="', h += r, h +=
					'"', h += ' height="', h += t, h += '"', n && (h += ' alt="', h += n, h += '"'), h += "/>"
			};
		return t
	}();
	return function(r) {
	...
	r.fn.share = function(t) {
		function e(t, e) {
			...
			"prepend" == e.mode && n.reverse(), n.length && r.each(n, function(n, o) {
				...
				f.prop("aria-label", "分享到 " + u[o]), f.prop("href", i), "wechat" === o ? f.prop("tabindex", -1) : f.prop(
					"target", "_blank"), e.initialized || ("prepend" == e.mode ? t.prepend(f) : t.append(f))
			})
		}
		var n = r(document.head),
			...
			a = {
				...
				qq: "http://connect.qq.com/widget/shareqq/iframe_index.html?url={{URL}}&title={{TITLE}}&source={{SOURCE}}&desc={{DESCRIPTION}}&pics={{IMAGE}}",
			...
			e(n, t),
				function(r, t) {
					...
					e.length && (e.append('<div class="wechat-qrcode"><h4>' + t.wechatQrcodeTitle +
						'</h4><div class="qrcode"></div><div class="help">' + t.wechatQrcodeHelper + "</div></div>"), e.find(
						".qrcode").qrcode({
						render: "image",
